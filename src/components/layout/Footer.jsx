    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.top}>
        ...
        <div className={styles.brand}>
          <div className={styles.logo}>Bag<em>Style</em></div>
          <p className={styles.tagline}>Sacs artisanaux personnalisés,<br />livrés avec amour à Abidjan.</p>
        ...
        <div className={styles.cards}>
          ...
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className={styles.card}>
            <div className={`${styles.icon} ${styles.iconWa}`}>
          ...
          <a href={MAPS_URL} target="_blank" rel="noopener noreferrer" className={styles.card}>
            <div className={styles.icon}>
              <MapPin size={20} />
            </div>
            <div>
              <div className={styles.cardLabel}>Notre boutique</div>
              <div className={styles.cardValue}>Carrefour Hôtel Blanc, Abidjan</div>
            </div>
            <svg className={styles.arrow} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
          </a>
      ...
      <div className={styles.bottom}>
        <span>© 2025 BagStyle — Abidjan</span>
        <span className={styles.made}>Fait avec <Heart size={11} fill="rgba(255,255,255,0.6)" stroke="none" /> à Abidjan</span>
      </div>
